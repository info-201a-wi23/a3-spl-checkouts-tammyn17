...
### Your Choice
After seeing the first chart about yearly, I was enticed to see what difference was for months. This chart shows 2022 and 2023 months combined. I chose a scatter plot because I thought it was the best way to able to see checkouts more individually. This is really interesting because some physical books actually topped digital on the y-axis. But in the end you can see the contrast of colors where digital takes over most of the chart. 

``````{r, echo = FALSE, code = readLines("extra_chart.R")}
```
